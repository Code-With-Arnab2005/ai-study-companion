...
import { generateNotes } from '@/lib/actions/ai-session-actions';
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <section className="lg:col-span-2 bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                {generatedNotes.length === 0 ? <div className='text-gray-800 text-lg h-full flex items-center justify-center'>Please generate a note</div>
                : isGenerating ?
                    (
