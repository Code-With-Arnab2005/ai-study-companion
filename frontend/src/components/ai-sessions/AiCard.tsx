...
const AiCard = ({ header, desc }: { header: string, desc: string }) => {
    ...
    return (
        <div className="group cursor-pointer rounded-2xl border border-sidebar-border bg-card text-card-foreground p-6 shadow-sm transform transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-md hover:cursor-pointer">
            ...
            <p className="mt-2 text-sm text-card-secondary-foreground">
                {desc}
            </p>
        </div>
    )
