...
const PublicNavbar = () => {
    ...
    return (
        <header className={`w-full fixed top-0 [background:var(--navbar_bg)] text-foreground border-b border-sidebar-border px-8 py-4 z-50`}>
            <div className={`max-w-8xl mx-auto flex items-center justify-between transition-all duration-300 ease-in-out`}>
                ...
                <nav className="hidden md:flex items-center gap-8">
                    {/* <a
                        href="/dashboard"
                        className="underline text-sm font-medium text-gray-700 hover:text-indigo-600 transition"
                    >
                        Go To Dashboard */}
                    {/* </a> */}
                    {/* <a
